...
namespace eShopSolution.Data.Migrations
{
    ...
    [Migration("20220224080939_updateImage")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("5ad03a27-92ce-4e87-b04d-dec46029317e"),
                            RoleId = new Guid("3f7fd59c-80fd-4989-be8f-384fec9e9097")
                        });
                });
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3f7fd59c-80fd-4989-be8f-384fec9e9097"),
                            ConcurrencyStamp = "5b452d4a-faf3-47b3-aabf-079dd41db9b0",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5ad03a27-92ce-4e87-b04d-dec46029317e"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "40bf9d92-d57f-406d-952b-fe44cf58afbf",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJoTr1oksZOhOXetwhU+D9f7EDW7tuli7iQgMTE0oEEQr4vCbKZQsQpbzqaugSUong==",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 24, 15, 9, 38, 327, DateTimeKind.Local).AddTicks(1838));
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 2, 24, 15, 9, 38, 351, DateTimeKind.Local).AddTicks(4293),
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.ProductImage", b =>
                {
                    b.HasOne("eShopSolution.Data.Entities.Product", "Product")
                        ...
                        .HasForeignKey("eShopSolution.Data.Entities.ProductImage", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
